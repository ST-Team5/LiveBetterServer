...
@Configurable
@RooJavaBean
@RooJpaActiveRecord(versionField = "", table = "drinks", schema = "public")
@RooDbManaged(automaticallyDelete = true)
@RooToString(excludeFields = { "personDrinkss" })
public class Drink {

	@Id
    @GeneratedValue(strategy = GenerationType.AUTO, generator = "drinks_seq")
